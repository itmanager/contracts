...
/**
 * Mapper for the entity {@link QualityKPI} and its DTO {@link QualityKPIDTO}.
 */
@Mapper(componentModel = "spring")
public interface QualityKPIMapper extends EntityMapper<QualityKPIDTO, QualityKPI> {
    ...
    QualityKPIDTO toDto(QualityKPI s);
