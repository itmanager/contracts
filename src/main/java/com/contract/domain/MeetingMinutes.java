...
public class MeetingMinutes implements Serializable {
    ...
    public MeetingMinutes meetingDate(ZonedDateTime meetingDate) {
    ...
    public MeetingMinutes nextMeetingDate(ZonedDateTime nextMeetingDate) {
        this.setNextMeetingDate(nextMeetingDate);
        return this;
    }
